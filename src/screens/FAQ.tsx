...
const FAQS: FAQItem[] = [
  ...
  {
    q: 'كيف يتم السحب؟',
    a: 'اذهب إلى صفحة الملف الشخصي، افتح خانة "Wallet" ثم اختر النصف السفلي "سحب"، أدخل المبلغ والمحفظة المربوطة، ثم أرسل الطلب. يتم مراجعة السحب وإرساله يدويًا من قبل الأدمن.',
  },
  {
  ...
  },
  {
    ...
    a: 'من صفحة الملف الشخصي افتح خانة "Wallet" ثم اختر النصف العلوي "إيداع". انسخ عنوان محفظة البوت، وأرسل مبلغ Gram من محفظتك. تتم الإضافة تلقائيًا بعد تأكيد الشبكة.',
  },
  {
