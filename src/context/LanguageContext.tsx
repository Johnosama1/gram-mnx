...
const isLang = (v: unknown): v is Lang => v === 'ar' || v === 'en' || v === 'ru';
  ...
  const t = useCallback((key: string, vars?: Record<string, string>): string => {
    ...
    const map =
      lang === 'ar'
        ...
        : lang === 'ru'
          ? (ruTranslations as Record<string, string>)
          : en;
    // English is the fallback for any key a translation file is missing.
