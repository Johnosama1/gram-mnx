...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mine Gram, buy miners, finish tasks and invite friends inside the GRAM MNX Telegram Mini App." },
      { property: "og:title", content: "GRAM MNX — Mine Gram in Telegram" },
      { property: "og:description", content: "Mine Gram, buy miners, finish tasks and invite friends inside the GRAM MNX Telegram Mini App." },
