-- Audit log for the admin panel's "Top Users" manual balance-deduction
-- feature: every deduction is recorded here (who, how much, when, which
-- admin, optional reason) — the deduction itself still just updates
-- gm_users.balance directly, this is purely the paper trail.
