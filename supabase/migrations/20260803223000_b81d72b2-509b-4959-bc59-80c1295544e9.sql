...
ADD COLUMN IF NOT EXISTS unclaimed_mining_balance double precision NOT NULL DEFAULT 0;
...
BEGIN
  ...
  -- Preserve accrued mining separately from the spendable wallet balance.
